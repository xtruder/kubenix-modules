...

{
  ...
  config = {
    ...
    kubernetes.modules.selfsigned-cert-deployer = {
      ...
      configuration.configuration = {
        ...
        resource.tls_cert_request.csr = {
          ...
          dns_names = config.args.dnsNames;
          ip_addresses = config.args.ipAddresses;
        ...
        resource.kubernetes_secret.selfsigned = {
          metadata.name = config.args.secretName;
    ...
    kubernetes.api.roles.selfsigned-deployer = {
    ...
    kubernetes.api.rolebindings.selfsigned-deployer = {
      apiVersion = "rbac.authorization.k8s.io/v1beta1";
      metadata.name = name;
      roleRef = {
