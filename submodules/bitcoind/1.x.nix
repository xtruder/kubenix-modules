...
in {
  ...
  config = {
    ...
    docker.images.bitcoind.image = pkgs.dockerTools.pullImage {
      imageName = "kylemanna/bitcoind";
      imageDigest = "sha256:7e0254a4a4f4b85a4926d6e0a339613d1d2112a59f07e9076a118a6fd0a0267e";
      sha256 = "1v1z1ay6ry9sd55fy3sxpc07864by4x3pf9vknj1pgvip6pmjxk2";
      finalImageName = "bitcoind";
    ...
    kubernetes.api.statefulsets.bitcoind = {
      metadata.name = name;
      ...
      spec = {
        ...
        template = {
          ...
          spec = {
            ...
            containers.bitcoind = {
              image = config.docker.images.bitcoind.path;
              imagePullPolicy = "IfNotPresent";
    ...
    kubernetes.api.configmaps.bitcoind = {
      metadata.name = "${name}-config";
      data."bitcoin.conf" = bitcoindConfig;
    };

    kubernetes.api.services.bitcoind = {
      metadata.name = name;
      metadata.labels.app = name;
      spec = {
        selector.app = name;
