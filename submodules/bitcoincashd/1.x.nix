...
in {
  ...
  config = {
    submodule = {
      name = "bitcoincashd";
      version = "1.0.0";
      description = "Bitcoincash node";
    };

    docker.images.bitcoincashd.image = pkgs.dockerTools.pullImage {
      imageName = "uphold/bitcoin-abc";
      imageDigest = "sha256:20fea16e57a8efbb8814e59ffa598e64ac3e805433e580bcd4dbb349a07e96f2";
      sha256 = "14fxm74blxw8whk613ksmnj8w65ivg3r664nbgsjn0iwwxi7b38j";
      finalImageName = "bitcoin-abc";
      finalImageTag = "0.18";
    };
        ...
        template = {
          ...
          spec = {
            ...
            containers.bitcoincashd = {
              image = config.docker.images.bitcoincashd.path;
