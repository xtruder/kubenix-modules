...
{
  config.kubernetes.moduleDefinitions.minio.module = {name, config, ...}: {
    options = {
      image = mkOption {
    ...
    config = {
      ...
      kubernetes.resources.configMaps.minio-config = {
        metadata.name = "${name}-config";
        metadata.labels.app = name;
        data."config.json" = builtins.toJSON config.configuration;
      };

      kubernetes.resources.services.minio = {
        metadata.name = name;
        metadata.labels.app = name;
        spec = {
          clusterIP = "None";
      ...
      kubernetes.resources.statefulSets.minio = {
        metadata.name = name;
        metadata.labels.app = name;
        spec = {
          serviceName = name;
